...
import { Mail, Linkedin, Phone, Send, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="bg-white/90 backdrop-blur-sm border-b border-border sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-navy-deep hover:text-teal-accent transition-colors"
          >
      ...
      <section className="py-20 px-6 bg-section-bg">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-3xl lg:text-4xl font-bold text-navy-deep mb-4">
              Get In Touch
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Methods */}
            <div>
              <h2 className="text-2xl font-semibold text-navy-deep mb-6">Contact Information</h2>
            ...
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl font-semibold text-navy-deep mb-6">Feel Free to Contact</h2>
              <Card className="p-6">
